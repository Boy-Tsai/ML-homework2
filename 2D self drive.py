...
class Car:
    ...
    def display_car(self): #定義出車子跑動的方法
        """
    ...
    def crash_check(self):  #定義出車子撞到的方法
        """
        檢查汽車的任何角落是否超出軌道
        Returns:
    ...
    def update_sensor_data(self):  #定義更新車子sensor的方法
        """
       軌道邊緣的點以及點到汽車中心的距離(特徵)
        """
    ...
    def display_edge_points(self):  #定義出車子顯示線條方法
        """
        顯示從汽車中心到賽道邊緣的線條
        """
    ...
    def update_position(self):   #定義出車子位置的方法
        """  
        更新汽車的新位置(類別)
        """
